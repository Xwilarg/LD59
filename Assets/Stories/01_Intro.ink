...
The region is not super developed right now but with a bit of effort I'm sure we will have enough funding to link all stations nearby
For now you only have access to the rails and eraser tool, try to link Ariëta and Sörena!
Use left click to place rails and right click to rotate them!
-> END